...
RUN curl -L -o phpmyadmin.tar.gz "http://files.phpmyadmin.net/phpMyAdmin/${PHPMYADMIN_MAJOR}.${PHPMYADMIN_MINOR}/phpMyAdmin-${PHPMYADMIN_MAJOR}.${PHPMYADMIN_MINOR}-all-languages.tar.gz"
